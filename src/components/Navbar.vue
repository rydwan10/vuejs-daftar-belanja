<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-1">
            ...
            <a class="navbar-brand" href="#">Vue Kasir
            </a>
...
<style scoped>
    ...
    nav {
        /* background: linear-gradient(90deg, rgba(71,112,255,1) 5%, rgba(91,158,96,1) 85%) !important; */
        background: linear-gradient(90deg, rgba(71,180,255,1) 5%, rgba(101,241,111,1) 85%) !important;
    }
    ul>li>a {
